...
Implements a subset-compatible interface with VoiceProfileRepository used by VoiceService.
"""
...
class CloudVoiceProfileRepository:
    """Repository that reads/writes profile JSON in Azure Blob only."""

    def __init__(self, blob_repo: AzureBlobRepository) -> None:
        self.blob_repo = blob_repo
        logger.info("CloudVoiceProfileRepository initialized (blob-only mode)")
